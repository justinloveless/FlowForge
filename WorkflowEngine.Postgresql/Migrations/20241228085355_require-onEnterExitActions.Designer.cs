...
namespace WorkflowEngine.Postgresql.Migrations
{
    ...
    [Migration("20241228085355_require-onEnterExitActions")]
    partial class requireonEnterExitActions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkflowEngine.Core.WorkflowDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WorkflowEngine.Core.WorkflowEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WorkflowEngine.Core.WorkflowInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WorkflowEngine.Core.WorkflowDefinition", b =>
                {
                    b.OwnsMany("WorkflowEngine.Core.StateDefinition", "States", b1 =>
                        {
                            ...
                            b1.Property<string>("OnEnterActions")
                                .HasColumnType("jsonb");

                            b1.Property<string>("OnExitActions")
                                .HasColumnType("jsonb");
                            ...
                            b1.OwnsOne("WorkflowEngine.Core.AssignmentRules", "Assignments", b2 =>
                                {
                            ...
                            b1.OwnsMany("WorkflowEngine.Core.TransitionDefinition", "Transitions", b2 =>
                                {
                                    b2.Property<Guid>("StateDefinitionWorkflowDefinitionId")
                                        .HasColumnType("uuid");
